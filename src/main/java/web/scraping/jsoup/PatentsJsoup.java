...
public class PatentsJsoup {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		org.jsoup.nodes.Document researchers = Jsoup.connect(URL_BASE).data("text2search", "%%%").data("en", "1")
		...
		for (String link : researchersLink) {
			...
			org.jsoup.nodes.Document doc = Jsoup.parse(new URL(URL_QUERY + link), 10000);
